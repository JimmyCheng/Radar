...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron" style="background-image:none;">
            <h1>I am sorry!</h1>
            <p>Jimmy, the ower of this website, is very busy right now. He is seeking Java Enigneer position in Australia. Now the main functionality of this website is done. Some remaining work
            will be done in the near future.</p>
            <p><a href="${ctx}/aboutme" class="btn btn-primary" role="button">Learn More</a> 
		</div>
